...
namespace HWD::Probe::Driver {
    ...
    public: // library functions
        ...
        int (*target_Erase)(void)                                                                                         = nullptr;
        void (*target_BeginDownload)(uint32_t Flags)                                                                      = nullptr;
        void (*session_Close)(void)                                                                                       = nullptr;
        ...
        int (*target_Connect)(void)                                                                                       = nullptr;
        void (*probe_EnableLogCallback)(JLink_Types::LogCallback pfLog)                                                   = nullptr;
        ...
        int (*target_EndDownload)(void)                                                                                   = nullptr;
        int (*probe_ExecuteCommand)(const char* pIn, char* pOut, int BufferSize)                                          = nullptr;
        int (*target_FindBreakpoint)(uint32_t Addr)                                                                       = nullptr;
        uint32_t (*target_GetBreakpointInfo)(int BPHandle)                                                                = nullptr;
        int (*target_GetBreakpointInfoEx)(int iBP, JLink_Types::BreakpointInfo* pInfo)                                    = nullptr;
        ...
        uint32_t (*probe_GetCapabilities)(void)                                                                           = nullptr;
        void (*probe_GetCapabilitiesEx)(JLink_Types::EmulatorExtendedCapabilities* pCaps, int BufferSize)                 = nullptr;
        void (*probe_GetFeatureString)(char* pOut)                                                                        = nullptr;
        void (*probe_GetFirmwareString)(char* s, int BufferSize)                                                          = nullptr;
        ...
        void (*target_Go)(void)                                                                                           = nullptr;
        void (*target_GoAllowSimulation)(uint32_t NumInsts)                                                               = nullptr;
        void (*target_GoNumberOfInstructions)(uint32_t MaxEmulInsts, uint32_t Flags)                                      = nullptr;
        int (*target_GoNumberOfClocks)(uint32_t NumClocks)                                                                = nullptr;
        void (*target_GoAndDisableInterrupts)(void)                                                                       = nullptr;
        ...
        char (*session_IsOpen)(void)                                                                                      = nullptr;
        ...
        const char* (*session_Open)(void)                                                                                 = nullptr;
        const char* (*session_OpenEx)(JLink_Types::LogCallback pfLog, JLink_Types::LogCallback pfErrorOut)                = nullptr;
        ...
        int (*target_WriteMemory)(uint32_t Addr, uint32_t Count, const void* pData)                                               = nullptr;
        ...
        int (*probe_IsCapableOfEx)(JLink_Types::EmulatorExtendedCapabilities CapEx)                                               = nullptr;
        ...
        int (*probe_HSS_GetCapabilities)(JLink_Types::HSS_Capabilities* pCaps)                                                    = nullptr;
        ...
        int (*target_RTT_Control)(JLink_Types::RTT_Command cmd, void* p)                                                          = nullptr;
        ...
        void (*target_GetAvailableInterfaces)(uint32_t* pMask)                                                                    = nullptr;
        int (*target_SelectInterface)(JLink_Types::TargetInterface targetIf)                                                      = nullptr;

...
#include <Core/Target/Cortex/DWT_Registers.hpp>
#include <Core/Target/Cortex/ITM_Registers.hpp>
#include <Core/Target/Cortex/ROM_Table.hpp>
#include <Core/Target/Cortex/TPIU_Registers.hpp>
#include <fstream>
#include <QFileDialog>
...
namespace L0::Test {
    ...
    void RVeips_ProbeTest::ProbeTest() {
        ...
        /*auto connectedProbes = JLink::GetConnectedProbes();

 ...
 * \return the regexp
 */
    QRegularExpression FuzzyMatcher::CreateRegularExpression(const QString &pattern, FuzzyMatcher::CaseSensitivity caseSensitivity) {
        if (pattern.isEmpty())
    ...
    Qt::CaseSensitivity.
 */
    QRegularExpression FuzzyMatcher::CreateRegularExpression(const QString &pattern, Qt::CaseSensitivity caseSensitivity) {
        const CaseSensitivity sensitivity =
            (caseSensitivity == Qt::CaseSensitive) ? CaseSensitivity::CaseSensitive : CaseSensitivity::CaseInsensitive;

        return CreateRegularExpression(pattern, sensitivity);
    }
 ...
 */
    FuzzyMatcher::HighlightingPositions FuzzyMatcher::GetHighlightingPositions(const QRegularExpressionMatch &match) {
